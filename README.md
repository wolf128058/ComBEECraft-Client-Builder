# ComBEECraft Client Builder

Build and maintain the client-side pack definition for ComBEECraft. This repo
keeps the Modrinth/CurseForge indexes and the overrides folder in sync so the
pack can be assembled consistently.
...
- For Server Version see: [ComBEECraft-Server-Builder](https://github.com/wolf128058/ComBEECraft-Server-Builder)
